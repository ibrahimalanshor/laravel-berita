<article class="flex items-start gap-3 relative">
    <div class="absolute top-0 right-0">
        ...
        <div id="report-{{ $comment->id }}" class="hidden shadow-md absolute top-6 right-0 bg-white border border-neutral-200 rounded-md p-4 space-y-2 z-10" data-click-outside-close="dropdown" data-ignore=".open-report-{{ $comment->id }}">
