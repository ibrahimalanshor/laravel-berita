    ...
    <div class="max-w-sm flex flex-col items-center justify-center">
        <div class="space-y-4 flex flex-col border w-full border-neutral-300 p-4 bg-white rounded-md mb-4">
            @if ($intentedToCheckout)
                <x-home.base.alert color="warning" icon="icon-[tabler--alert-triangle-filled]">
            ...
            <x-home.base.button tag-name="a" href="{{ route('auth.google') }}" color="primary" icon="icon-[tabler--brand-google-filled]">Lanjutkan dengan Google</x-base.button>
        </div>
