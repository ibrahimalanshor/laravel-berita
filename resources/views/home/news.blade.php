...
<x-home.base.container :paddless="true" class="mb-2 sm:px-4 lg:mb-0">
...
<x-home.base.container class="border-t border-neutral-300 pt-2 lg:border-0 lg:py-0 lg:px-4">
